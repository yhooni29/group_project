...
#print(leezea.normal_station())
heeju = Express_9('line_9','express')
#print((heeju.express_station()))
#print(leezea.normol_where('마곡나루'))
print(leezea.normal_destination('선정릉','고속터미널'))
#print(heeju.express_where('당산'))
#print(heeju.express_destination('당산','선정릉'))
#
